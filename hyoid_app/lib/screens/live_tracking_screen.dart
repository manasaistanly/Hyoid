...
class _LiveTrackingScreenState extends State<LiveTrackingScreen>
  ...
  void initState() {
    ...
    if (_isLabBooking) {
      _currentReport = globalLabReports.value.isNotEmpty
          ? globalLabReports.value.first
          : null;
      _reportTimer = Timer(const Duration(seconds: 8), () {
        ...
        if (reports.isNotEmpty) {
          ...
          globalLabReports.value = [
            updatedReport,
            ...reports.where((element) => element.id != report.id),
          ];
          setState(() {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Pulsing Effect Over Map (Fixed relative to the center)
          Align(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: widget.booking.color.withValues(
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    final report =
                                        globalLabReports.value.isNotEmpty
                                        ? globalLabReports.value.first
                                        : null;
                                    if (report != null) {
                                      Navigator.push(
            ...
            Text(
              ...
              style: TextStyle(
                color: isCurrent
                    ...
                    : (isCompleted ? Colors.white : Colors.white54),
